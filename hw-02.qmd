...
ggplot(df, aes(x=col1, y=col2)) +
 ...
 coord_fixed(clip="off") + 
  ...
  annotate("text", label="TARGET", x=50, y=0, vjust=2, color="#CC0000", size=12, fontface="bold") +
    geom_circle(aes(x0=110, y0=-38, r=6), fill="white", color="#CC0000", inherit.aes=FALSE, linewidth=1) + 
    annotate("text", label="R", x=110, y=0, vjust=6.44, color="#CC0000", size=4, fontface="bold")
